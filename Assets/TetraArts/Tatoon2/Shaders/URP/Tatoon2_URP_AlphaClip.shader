...
Shader "TetraArts/Tatoon2/URP/Tatoon2_URP_AlphaClip"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 MyAddLight584( float3 WorldPosition, float3 WorldNormal )
			{
				float3 Color = 0;
			...
			float3 MyAddLight2589( float3 WorldPosition, float3 WorldNormal )
			{
				float3 Color = 0;
				#ifdef _ADDITIONAL_LIGHTS
				int numLights = GetAdditionalLightsCount();
						 ...
						 ) : SV_Target
			{
				...
				float4 ShadowColor157 = (( _UseGradient )?( ( (( _UseShadow )?( (( _UseShadowTexture )?( ( ( Texture536 * ( ( _ShadowColor * ( temp_output_479_0 * ( ( 1.0 - ( ( ( 1.0 - tex2D( _ShadowTexture, rotator250 ) ) * ( 1.0 - smoothstepResult252 ) ) + (( _Level2 )?( ( ( 1.0 - tex2D( _ShadowTexture, rotator242 ) ) * ( 1.0 - smoothstepResult254 ) ) ):( float4( 0,0,0,0 ) )) + (( _Level3 )?( ( ( 1.0 - tex2D( _ShadowTexture, rotator247 ) ) * ( 1.0 - smoothstepResult257 ) ) ):( float4( 0,0,0,0 ) )) ) ) - temp_cast_21 ) ) ) + clampResult505 ) ) * Color156 ) ):( ( Color156 * ( ( _ShadowColor * temp_output_479_0 ) * Texture536 ) ) )) ):( Color156 )) * Gradient567 ) ):( (( _UseShadow )?( (( _UseShadowTexture )?( ( ( Texture536 * ( ( _ShadowColor * ( temp_output_479_0 * ( ( 1.0 - ( ( ( 1.0 - tex2D( _ShadowTexture, rotator250 ) ) * ( 1.0 - smoothstepResult252 ) ) + (( _Level2 )?( ( ( 1.0 - tex2D( _ShadowTexture, rotator242 ) ) * ( 1.0 - smoothstepResult254 ) ) ):( float4( 0,0,0,0 ) )) + (( _Level3 )?( ( ( 1.0 - tex2D( _ShadowTexture, rotator247 ) ) * ( 1.0 - smoothstepResult257 ) ) ):( float4( 0,0,0,0 ) )) ) ) - temp_cast_21 ) ) ) + clampResult505 ) ) * Color156 ) ):( ( Color156 * ( ( _ShadowColor * temp_output_479_0 ) * Texture536 ) ) )) ):( Color156 )) ));
				...
				float3 WorldPosition584 = WorldPosition;
				float3 WorldNormal584 = WorldNormal;
				float3 localMyAddLight584 = MyAddLight584( WorldPosition584 , WorldNormal584 );
				float3 WorldPosition589 = WorldPosition;
				float3 WorldNormal589 = WorldNormal;
				float3 localMyAddLight2589 = MyAddLight2589( WorldPosition589 , WorldNormal589 );
				float3 AddLightColor588 = (( _Normalize )?( localMyAddLight2589 ):( localMyAddLight584 ));
				float4 Result195 = ( (( _UseRamp )?( ShadowRamp424 ):( ( ( ShadowColor157 * ( 1.0 - temp_output_124_0 ) ) + ( temp_output_124_0 * Color156 ) ) )) + Specular359 + Rim317 + Emissiv453 + float4( AddLightColor588 , 0.0 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 Emissiv453 = (( _UseEmissive )?( ( _EmissiveColor * tex2D( _EmissiveMap, uv_EmissiveMap ) ) ):( float4( 0,0,0,0 ) ));
				float3 WorldPosition584 = WorldPosition;
				float3 WorldNormal584 = ase_worldNormal;
				float3 localMyAddLight584 = MyAddLight584( WorldPosition584 , WorldNormal584 );
				float3 WorldPosition589 = WorldPosition;
				float3 WorldNormal589 = ase_worldNormal;
				float3 localMyAddLight2589 = MyAddLight2589( WorldPosition589 , WorldNormal589 );
				float3 AddLightColor588 = (( _Normalize )?( localMyAddLight2589 ):( localMyAddLight584 ));
				float4 Result195 = ( (( _UseRamp )?( ShadowRamp424 ):( ( ( ShadowColor157 * ( 1.0 - temp_output_124_0 ) ) + ( temp_output_124_0 * Color156 ) ) )) + Specular359 + Rim317 + Emissiv453 + float4( AddLightColor588 , 0.0 ) );
	...
	CustomEditor "TA_TatoonEditor.TatoonEditorURP_AlphaClip"
...
Node;AmplifyShaderEditor.CommentaryNode;19;-6969.498,-511.8786;Inherit;False;3344.688;1216.413;Comment;35;195;546;583;390;28;22;360;165;9;24;277;26;485;417;496;25;162;150;490;427;21;448;491;318;11;426;454;416;20;16;151;149;276;124;488;Lighting;1,0.9979696,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;583;-5623.146,213.4393;Inherit;False;1060.696;389.6102;Comment;6;589;588;587;586;585;584;AddLights;1,0.9644862,0,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;219;-11086.93,-2590.779;Inherit;False;7030.778;1753.407;Shadow;79;229;477;274;228;482;223;252;231;271;502;238;226;505;265;230;240;249;263;269;234;235;267;268;236;248;259;393;389;264;568;224;241;227;270;247;388;260;254;394;537;538;262;221;225;258;243;261;245;237;161;272;157;569;494;570;244;391;251;135;222;253;220;239;257;266;232;246;395;233;256;392;255;479;250;242;580;579;581;582;Shadow tex&color;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;471;-2147.199,-2134.107;Inherit;False;856.4039;821.6099;Comment;11;578;458;577;507;73;508;196;187;469;468;440;Master;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;321;-10092.29,983.5153;Inherit;False;3301.643;968.2485;Specular;39;359;358;357;356;355;354;353;352;351;350;349;348;347;346;345;344;343;342;340;339;338;337;336;334;333;332;331;330;329;328;327;326;325;324;323;322;572;573;574;Specular;0,1,0.07320952,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;392;-10538.72,-1130.564;Inherit;False;Property;_YDirectionSpeed;YDirectionSpeed;49;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;479;-6117.847,-1895.966;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;255;-8708.683,-1847.268;Inherit;True;Property;_TextureSample2;Texture Sample 2;13;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;395;-9925.384,-1491.689;Inherit;False;Property;_Animate;Animate;50;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;426;-4305.81,-169.4902;Inherit;False;Property;_UseRamp;UseRamp;52;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;161;-5167.094,-2031.723;Inherit;False;156;Color;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;582;-5583.951,-1657.021;Inherit;False;156;Color;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;272;-5225.255,-1904.593;Inherit;False;Property;_UseShadowTexture;UseShadowTexture;39;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;538;-5488.915,-1800.206;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;494;-5489.109,-1970.292;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;580;-5343.685,-1745.355;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;579;-5361.351,-2042.158;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;588;-4791.146,309.4392;Inherit;False;AddLightColor;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;581;-5545.084,-2135.792;Inherit;False;156;Color;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;195;-3874.817,-171.1764;Inherit;False;Result;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;157;-4386.165,-1924.585;Inherit;False;ShadowColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;135;-5833.563,-2131.984;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.OneMinusNode;574;-7785.044,1678.444;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;505;-6324.838,-1872.935;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;568;-4637.331,-1925.855;Inherit;False;Property;_UseGradient;Use Gradient;15;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;458;-1890.441,-1613.922;Inherit;False;Constant;_Float1;Float 1;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;546;-4287.816,210.2412;Inherit;False;588;AddLightColor;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;577;-2015.824,-1433.024;Inherit;False;Property;_AlphaClip;AlphaClip;47;0;Create;False;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;270;-6310.96,-2145.913;Inherit;False;Property;_ShadowColor;Shadow Color;10;0;Create;True;0;0;0;False;0;False;0.5849056,0.5849056,0.5849056,1;0.8018868,0.8018868,0.8018868,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;376;-9083.063,-3509.429;Inherit;False;Property;_ColorB;Color B;16;0;Create;True;0;0;0;False;0;False;0,0.1264467,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;348;-8334.121,1122.549;Inherit;False;Property;_SpecularColor;Specular Color;38;0;Create;True;0;0;0;False;0;False;0,1,0.8745098,0;1,0.9575656,0.75,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;271;-6019.058,-1761.229;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;502;-5659.05,-1780.845;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;537;-5699.15,-1895.017;Inherit;False;536;Texture;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;393;-10540.06,-1214.604;Inherit;False;Property;_XDirectionSpeed;XDirectionSpeed;48;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;274;-4989.097,-1925.448;Inherit;False;Property;_UseShadow;UseShadow;22;0;Create;True;0;0;0;False;0;False;1;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;569;-4980.338,-1746.237;Inherit;False;567;Gradient;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;482;-6613.161,-1994.23;Inherit;True;276;Lighting;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;477;-5841.16,-1777.717;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;73;-1599.224,-1868.953;Float;False;True;-1;2;TA_TatoonEditor.TatoonEditorURP_AlphaClip;0;12;TetraArts/Tatoon2/URP/Tatoon2_URP_AlphaClip;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;True;True;0;False;;True;0;False;;True;False;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;5;True;12;all;0;False;True;0;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;True;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;0;638047077611009885;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;638047072735636116;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;8;False;True;True;True;True;False;True;True;False;;False;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;585;-4999.146,309.4392;Inherit;False;Property;_Normalize;Normalize;8;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;272;0;579;0
WireConnection;272;1;580;0
...
WireConnection;580;0;538;0
WireConnection;580;1;582;0
WireConnection;579;0;581;0
WireConnection;579;1;494;0
...
WireConnection;73;6;578;0
WireConnection;73;7;577;0
WireConnection;585;0;584;0
WireConnection;585;1;589;0
ASEEND*/
//CHKSM=7A8A13DAD6C1BCB5996074A97E9EEDA9787D9609